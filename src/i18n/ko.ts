...
export const ko: Translation = {
  ...
  hero: {
    ...
    imageAlt: "Sihanouk Cake & Flower의 분홍 장미로 장식된 신선한 축하 케이크",
  ...
  products: {
    ...
    galleryTitle: "Sihanouk Cake & Flower의 실제 케이크 & 꽃",
    galleryText:
  ...
  delivery: {
    ...
    imageAlt: "Sihanouk Cake & Flower의 부드러운 분홍색과 크림색 꽃다발",
    floatTitle: "🛵 무료 배송",
    floatSub: "$20 이상 주문 시",
    note:
  ...
  howToOrder: {
    ...
    steps: [
      {
        title: "둘러보기",
        text: "Sihanouk Cake & Flower Telegram 채널에서 최신 케이크, 꽃, 사진 및 가격을 확인하세요.",
        cta: "Telegram에서 보기",
      },
      {
        title: "선택하기",
  ...
  orderForm: {
    ...
    submitting: "요청 보내는 중…",
    disclaimer:
      "이 양식을 제출하는 것은 주문 요청만 의미하며 주문이 자동으로 확정되는 것은 아닙니다. 제품 가능 여부, 최종 가격 및 배송 정보는 Sihanouk Cake & Flower가 Telegram을 통해 확인합니다.",
    ...
    successNotePrefix:
      "주문 요청이 접수되었지만 Sihanouk Cake & Flower가 Telegram을 통해 확인하기 전까지는",
    ...
    summary: {
      ...
      intro: "안녕하세요, Sihanouk Cake & Flower! 주문하고 싶습니다:",
      name: "이름",
      contact: "연락처",
      product: "제품",
      location: "배송 장소",
  ...
  chatbot: {
    ...en.chatbot,
    title: "Sihanouk Cake & Flower 도우미",
    status: "온라인 — 즉시 답변",
    openLabel: "Sihanouk Cake & Flower 도우미 채팅 열기",
    closeLabel: "Sihanouk Cake & Flower 도우미 닫기",
    closeChat: "채팅 닫기",
    placeholder: "케이크, 꽃, 배송에 대해 물어보세요…",
    inputLabel: "도우미에게 메시지를 입력하세요",
    sendLabel: "메시지 보내기",
    welcome:
      "안녕하세요! 👋 시하누크빌의 Sihanouk Cake & Flower에 오신 것을 환영합니다. 영업시간, 케이크 맛, 꽃, 배송 및 주문에 대해 도와드릴 수 있습니다. 무엇을 도와드릴까요?",
    ...
    replies: {
      ...
      greeting: "안녕하세요! 😊 Sihanouk Cake & Flower에 오신 것을 환영합니다. 오늘 무엇을 도와드릴까요?",
      goodbye:
        "안녕히 가세요! 👋 Sihanouk Cake & Flower를 방문해 주셔서 감사합니다. 언제든 Telegram에서 @da723으로 문의해 주세요!",
      fallback:
        "죄송합니다. 해당 정보는 현재 제공할 수 없습니다. 최신 정보는 Telegram에서 Sihanouk Cake & Flower의 @da723으로 문의해 주세요.",
    ...
    order: {
      ...
      recapWarning:
        "⚠️ 참고해 주세요: 주문은 아직 확정되지 않았습니다. 제품 가능 여부, 최종 가격 및 배송 정보는 Sihanouk Cake & Flower가 확인해야 합니다. 주문을 확정하려면 이 요청을 Telegram의 @da723에게 보내주세요. 📲",
      summaryIntro: "안녕하세요, Sihanouk Cake & Flower! 주문하고 싶습니다:",
      summaryName: "이름",
      summaryContact: "연락처",
      summaryProduct: "제품",
